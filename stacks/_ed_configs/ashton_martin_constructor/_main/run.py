def run(stackargs):
    ...
    # Add hostgroups
    stack.add_execgroup("bill12252016:::formula1::british_controls", "controls")
    ...
    inputargs["human_description"] = 'Executing substack "{}"'.format(stack.redbull_platform.name)
    stack.redbull_platform.insert(display=True,**inputargs)
